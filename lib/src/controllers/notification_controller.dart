  ...
  void listenForNotifications({String message}) async {
    ...
    stream.listen((model.Notification _notification) {
      ...
      if (notifications.isNotEmpty) {
        unReadNotificationsCount = notifications.where((model.Notification _n) => _n!=null && _n.read != null && !_n.read ?? false).where((element) => element.createdAt != DateTime(0)).toList().length;
      } else {
