...
class MapWidget extends StatefulWidget {
  ...
  MapWidget({Key key, this.restaurant, this.parentScaffoldKey}) : super(key: key);
...
class _MapWidgetState extends StateMVC<MapWidget> {
  ...
  @override
  void initState() {
    _con.restaurant = widget.restaurant;
    if (_con.restaurant?.latitude != null) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          S.of(context).restaurant_location,
