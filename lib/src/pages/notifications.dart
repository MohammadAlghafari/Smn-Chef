  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: _con.notifications.where((element) => element.createdAt != DateTime(0)).toList().isEmpty
            ...
            : ListView(
                ...
                children: <Widget>[
                  ...
                  ListView.separated(
                    ...
                    shrinkWrap: true,
                    primary: false,
                    itemCount: _con.notifications.where((element) => element.createdAt != DateTime(0)).toList().length,
                    separatorBuilder: (context, index) {
                      return SizedBox(height: 15);
                    },
                    itemBuilder: (context, index) {
                      return NotificationItemWidget(
                        notification: _con.notifications.where((element) => element.createdAt != DateTime(0)).toList().elementAt(index),
                        onMarkAsRead: () {
                          _con.doMarkAsReadNotifications(
                              _con.notifications.where((element) => element.createdAt != DateTime(0)).toList().elementAt(index));
                        },
                        onMarkAsUnRead: () {
