...
class S {
  ...
  /// `Kitchen refreshed successfully`
  ...
  /// `You don't have kitchens, please signin using admin panel and open new kitchen`
  String get you_dont_have_restaurants_please_signin_using_admin_panel_and_open_new_restaurant {
    return Intl.message(
      'You don\'t have kitchens, please signin using admin panel and open new kitchen',
      name: 'you_dont_have_restaurants_please_signin_using_admin_panel_and_open_new_restaurant',
      desc: '',
      args: [],
    );
  }
